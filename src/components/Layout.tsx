      ...
      >
        <div className="h-full flex flex-col">
          ...
          <div className="p-6 border-b border-sidebar-border">
            <h1 className="font-heading font-bold text-xl tracking-tight text-sidebar-foreground">
              MOON RIVER
              <span className="block text-sm font-normal text-sidebar-foreground/70 font-mono mt-1">KNOWLEDGE BASE</span>
            </h1>
          </div>
